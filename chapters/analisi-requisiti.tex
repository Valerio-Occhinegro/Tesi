...
\begin{usecase}{0}{Scenario principale}
    ...
    \usecasepost{Il sistema è pronto per eseguire il \emph{workflow}}
...
\begin{usecase}{1}{Acquisizione screenshot} 
    ...
    \usecasedesc{Il programmatore prepara il \emph{workflow} per acquisire in maniera automatica gli screenshot delle pagine raccolte in precedenza} 
...
\begin{usecase}{2}{Clusterizzazione degli screenshot} 
    ...
    \usecasedesc{Il programmatore avvia il processo di \emph{clustering}, che organizza gli screenshot in \emph{cluster} in base alle \emph{feature}\glsfirstoccur estratte} 
...
\begin{usecase}{3}{Valutazione qualitativa e classificazione} 
    ...
    \usecasedesc{Lo sviluppatore addestra l'IA classificativa sfruttando i cluster precedentemente creati, e creando un \emph{dataset}} 
